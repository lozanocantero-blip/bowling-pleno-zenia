...
// ── Schema.org JSON-LD ────────────────────────────────────────────────────────
// Inyectado en <head> para que Google lo lea como rich result.
// EntertainmentBusiness + BowlingAlley cubre el tipo de negocio exacto.
const schemaOrg = {
  ...
  "description":
    "Bolera en Orihuela Costa con 10 pistas de bowling, sala de arcade, Irish Pub Dublin House y paquetes de cumpleaños. Abiertos 365 días en Zenia Boulevard, Alicante.",
  ...
  "address": {
    "@type": "PostalAddress",
    "streetAddress": "Calle Jade 2, CC Zenia Boulevard",
  ...
  "amenityFeature": [
    ...
    { "@type": "LocationFeatureSpecification", "name": "Aparcamiento gratuito CC Zenia Boulevard", "value": true }
  ],
  "sameAs": [
