      ...
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="/contacto" className="rounded-full bg-brand-red text-white px-8 py-3.5 font-bold uppercase tracking-wider text-sm hover:bg-red-700 transition-colors">{t("btn1")}</a>
