...
const photos = [
  { src: "/images/bolera-orihuela-costa-10-pistas.jpg", alt: "10 pistas de bowling Bowling Pleno Zenia Orihuela Costa Zenia Boulevard", span: "row-span-2" },
  { src: "/images/bolera-pistas.jpg", alt: "Pistas de bolera iluminadas Bowling Pleno Zenia Orihuela Costa" },
  { src: "/images/bolera.jpeg", alt: "Sala de bowling familiar Bowling Pleno Zenia Zenia Boulevard Orihuela Costa Alicante" },
];

export function Gallery9() {
  const t = useTranslations("bolera_page.gallery");
  return (
