        ...
        <div className="grid grid-cols-1 items-start gap-x-12 gap-y-5 md:grid-cols-2 lg:gap-x-20 lg:gap-y-16">
          ...
          <div>
            <p className="text-text-alternative md:text-md">
              Tu cumpleaños o evento especial merece un lugar donde la diversión
              sea de verdad. En Bowling Pleno Zenia tenemos todo lo que
              necesitas para que ese día sea memorable.
            </p>
          </div>
        </div>
      </div>
