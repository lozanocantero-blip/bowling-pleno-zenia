      ...
      <div className="relative z-10 w-full px-[5%] pb-16 md:pb-20">
        ...
        <div className="flex flex-wrap gap-4">
          <a href="https://wa.me/34965355815" target="_blank" rel="noopener noreferrer"
            className="rounded-full text-white px-8 py-3.5 font-bold uppercase tracking-wider text-sm transition-colors btn-lift"
            style={{ background: "#0072CE" }}>
            Reservar mi fiesta
          </a>
          <a href="#paquetes"
            className="rounded-full border-2 border-white/40 text-white/80 px-8 py-3.5 font-bold uppercase tracking-wider text-sm hover:border-white hover:text-white transition-colors btn-lift">
            Ver paquetes
          </a>
        </div>
      </div>
